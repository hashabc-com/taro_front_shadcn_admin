  ...
  zh: {
    ...
    config: {
      ...
      paymentChannel: {
        ...
        noSubChannels: '暂无子渠道',
        deleteSubChannelConfirmation: '确定要删除子渠道"{name}"吗？此操作不可撤销。',
  ...
  en: {
    ...
    business: {
      ...
      customerConsult: {
        ...
        description: 'View and manage customer consultations and follow-up records',
        ...
        followUp: 'Follow Up',
        followUpDescription: 'Update customer follow-up information',
        ...
        pleaseEnterFollowBy: 'Please enter follow-up person',
        attachmentUrls: 'Attachment URLs',
        attachmentUrlsPlaceholder: 'Separate multiple URLs with commas',
        statusValues: {
          NEW: 'New',
          FOLLOWING: 'Following',
          DEAL: 'Deal Closed',
    ...
    config: {
      ...
      paymentChannel: {
        ...
        rateConfig:'Rate Config',
        deleteConfirmation: 'Are you sure you want to delete channel "{name}"? This action cannot be undone.',
        ...
        deleteSubChannelConfirmation: 'Are you sure you want to delete sub channel "{name}"? This action cannot be undone.',
