...
const initialToken =
  typeof localStorage !== 'undefined' ? localStorage.getItem('_token') : null
const initialUserInfo =
  typeof localStorage !== 'undefined'
    ? JSON.parse(localStorage.getItem('_userInfo') || 'null')
    : null
const initialPermissions =
  typeof localStorage !== 'undefined'
    ? JSON.parse(localStorage.getItem('_permissions') || 'null')
    : null
