    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-h-[85vh] max-w-[900px] overflow-y-auto'>
        ...
        <div className='space-y-4'>
          <div className='border-b-2 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.basicInfo')}
          </div>
          <InfoRow
          ...
          />
          <InfoRow
            label={t('logs.merchantRequest.appid')}
            value={record.appid || '-'}
          />
          <InfoRow
          ...
          />
          <InfoRow
            label={t('logs.merchantRequest.parameTwo')}
            value={record.parameTwo || '-'}
          />
          <InfoRow
            label={t('logs.merchantRequest.country')}
          ...
          <div className='border-b-2 pt-4 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.userInfo')}
          </div>
          <InfoRow
            label={t('logs.merchantRequest.userName')}
            value={record.userName || '-'}
          />
          <InfoRow
            label={t('logs.merchantRequest.mobile')}
            value={record.mobile || '-'}
          />
          <InfoRow
            label={t('logs.merchantRequest.address')}
            value={record.address || '-'}
          />

          <div className='border-b-2 pt-4 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.amountInfo')}
          </div>
          <InfoRow
          ...
          <div className='border-b-2 pt-4 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.paymentInfo')}
          </div>
          <InfoRow
          ...
          />
          <InfoRow
            label={t('logs.merchantRequest.url')}
            value={record.url || '-'}
          />
          <InfoRow
          ...
          <div className='border-b-2 pt-4 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.timeInfo')}
          </div>
          <InfoRow
          ...
          />
          <InfoRow
            label={t('logs.merchantRequest.localTime')}
            value={record.localTime || '-'}
          />

          <div className='border-b-2 pt-4 pb-2 text-base font-semibold'>
            {t('logs.merchantRequest.requestResponseParams')}
          </div>
          <div className='space-y-2'>
            <div className='text-sm font-medium'>
              {t('logs.merchantRequest.requestParam')}:
            </div>
          ...
          <div className='space-y-2'>
            <div className='text-sm font-medium'>
              {t('logs.merchantRequest.responseParam')}:
            </div>
            <pre className='bg-muted max-h-[250px] overflow-auto rounded-md p-3 text-xs'>
          ...
          {record.request && (
            <div className='space-y-2'>
              <div className='text-sm font-medium'>
                {t('logs.merchantRequest.request')}:
              </div>
              <pre className='bg-muted max-h-[250px] overflow-auto rounded-md p-3 text-xs'>
          ...
          {record.response && (
            <div className='space-y-2'>
              <div className='text-sm font-medium'>
                {t('logs.merchantRequest.response')}:
              </div>
              <pre className='bg-muted max-h-[250px] overflow-auto rounded-md p-3 text-xs'>
